...
# -*- coding: utf-8 -*-
"""
BIPED training script (DMOR-Edge).

Output layout mirrors BSDS scripts:
  __out_dir__/ckpt/biped_best.pth
  __out_dir__/ckpt/biped_last.pth
...
def parse_args():
    ...
    p.add_argument("--modality", default="n/a", help="NYUD only: rgb or hha")
    ...
    p.add_argument("--tag", default="biped")
    return p.parse_args()
